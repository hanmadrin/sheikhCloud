const generateDebitInvoiceParams = () => {
    const validParams = [
        ...
        {dbColumn:'invoice_category',name:'category',default: ''},
        {dbColumn:'invoice_ratetype',name:'rateType',default: ''},
...
export default generateDebitInvoiceParams;